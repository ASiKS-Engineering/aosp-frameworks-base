...
import com.asiks.camper.navigator.CamperNavigatorService;
...
public final class SystemServer implements Dumpable {
    ...
    private void startOtherServices(@NonNull TimingsTraceAndSlog t) {
        ...
        if (mFactoryTestMode == FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            t.traceBegin("StartCamperNavigatorService");
            mSystemServiceManager.startService(CamperNavigatorService.class);
            t.traceEnd();
